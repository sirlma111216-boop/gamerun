...
export class Connection {
 socket:WebSocket|null=null;credentials:Credentials|null=null;/** 강의 앱 티켓 — 연동 방은 재접속도 티켓으로 한다 */ticket:string|null=null;stopped=false;retry=0;timer:ReturnType<typeof setTimeout>|null=null;state:Snapshot|null=null;
 ...
 connect(message:Record<string,unknown>){
  this.stopped=false;if(typeof message.ticket==='string')this.ticket=message.ticket;this.onStatus('서버에 연결 중');this.socket=new WebSocket(this.url);
